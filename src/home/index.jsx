                    ...
                    <div className="flex w-5/6 flex-col gap-6">
                        ...
                        <div className="flex flex-col rounded-md border border-gray-100">
                            ...
                            {projects.map((project) => {
                                return <Project project={project} key={project.id} selected={selected?.id === project.id} setSelected={setSelected} />;
                            })}
                        </div>
...
function Project({ project, selected, setSelected }) {
    ...
    return (
        <div className={`flex flex-row items-center border-y border-gray-100 p-2 ${selected ? " bg-zinc-100" : ""}`} onClick={() => setSelected(project)}>
