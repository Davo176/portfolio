    ...
    return (
        <div>
            ...
            <p className="pt-2">
                ...
                delivered a highly commended feature entitled 'Task Templates', making our customers lives easier. I implemented a support bot for our customers
                to quickly get answers to questions about our product. After a few outages, I was also tasked with designing our platform outages alerts and
                dashboards, which helped me learn the ins and outs of AWS. Overall, as a junior engineer, I learnt a lot about the software development process.
            </p>
            <SectionHeader>
            ...
            <p className="pt-2">
                ...
                practice-management solution, built a system for distributing and managing 'Master Report Templates', and worked with SharePoint API's on a
                feature enabling our customers to share documents with their clients.
            </p>
        </div>
    );
}
